            ...
            dbc.Col(
                dbc.Card([
                    dbc.CardHeader(
                        ...
                        dbc.Tooltip("A utility token for the C3 carbon bridge. \
                            It is distributed as a reward to users of the protocol that stake, bridge or provide liquidity.",
