            ...
            dbc.Col(
                dbc.Card(
                    [
                        dbc.CardHeader(
                            html.H1(
                                "State of Toucan Digital Carbon", className="page-title"
                            )
                        )
                    ]
                ),
                ...
                dbc.Col(
                    [
                        dbc.Card(
                            [
                                html.H5(
                                    "Breakdown of TCO2 Pooled", className="card-title"
                                ),
            ...
            [
                ...
                dbc.Col(
                    dbc.Card(
                        [
                            dbc.CardBody(
                                html.H2(id="Last X Days"), style={"textAlign": "center"}
                            )
                        ]
                    ),
                    lg=6,
