            ...
            [
                ...
                dbc.Col(
                    dbc.Card(
                        [
                            dbc.CardBody(
                                html.H2("Deep Dive into Bridged MCO2"),
                                style={"textAlign": "center"},
                            )
                        ]
                    ),
            ...
            [
                ...
                dbc.Col(
                    dbc.Card(
                        [
                            html.H5(
                                "Cumulative Tonnes Bridged Over Time",
                ...
                dbc.Col(
                    [
                        dbc.Card(
                            [
                                html.H5(
                                    "MCO2 Composition Details", className="card-title"
                                ),
                                dash_table.DataTable(
                                    mco2_carbon.to_dict("records"),
                                    [
                                        {
                                            "name": i,
                                            "id": i,
                                            ...
                                            html.Div(
                                                [
                                                    html.Button(
                                                        ...
                                                        id="download_btn_MCO2",
                                                        className="download_btn",
                                                    ),
                                                    dcc.Download(
                                                        id="download_csv_MCO2"
                                                    ),
                                                ],
